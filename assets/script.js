(function () {
  ...
  const translations = {
    pt: {
      ...
      'hero.h1': 'Desenvolvo, aprendo e resolvo problemas em tecnologia.',
      ...
      'about.lead': 'Um olhar mais próximo sobre de onde venho, o que gosto de fazer e o que moldou a forma como encaro o trabalho.',
      'about.p1': 'Chamo-me Nilson Cardoso. Cresci em Luanda, Angola, e vim para Portugal aos 17 anos para frequentar a licenciatura em Engenharia Informática.',
      'about.p2': 'Aos 18 anos comecei a viver sozinho e passei a ser responsável por gerir a minha própria vida enquanto continuava os estudos. Essa experiência reforçou a minha autonomia, capacidade de adaptação e abordagem prática à resolução de problemas.',
      'about.p3': 'Fora da tecnologia, gosto de ir ao ginásio e fazer exercício, já pratiquei artes marciais, tenho há vários anos interesse por fotografia e atualmente estou a aprender piano.',
      ...
      'about.tl1Desc': 'Mudei-me de Luanda para Portugal para estudar no ensino superior.',
      'about.tl2Title': 'Comecei a viver de forma independente',
      'about.tl2Desc': 'Comecei a viver sozinho enquanto estudava.',
      'about.tl3Title': 'Comecei a universidade',
      'about.tl3Desc': 'Estudei Engenharia Informática na Universidade Lusófona do Porto.',
      'about.tl4Title': 'Concluí a licenciatura',
      'about.tl4Desc': 'Terminei a licenciatura e o projeto final, o RiskTrack, com nota de 18/20.',
      'about.outsideTech': 'Fora da tecnologia',
      'about.thingsIEnjoy': 'Coisas de que gosto.',
      'about.hobby1Title': 'Fotografia',
      'about.hobby1Desc': 'Já dediquei bastante tempo à fotografia e continuo a gostar do lado visual da coisa.',
      'about.hobby2Title': 'Treino',
      'about.hobby2Desc': 'O ginásio e o exercício físico fazem parte da forma como me mantenho ativo e equilibrado.',
      'about.hobby3Title': 'Artes marciais',
      'about.hobby3Desc': 'Já pratiquei artes marciais e gostei bastante da disciplina que isso trazia.',
      'about.hobby4Title': 'Piano',
      'about.hobby4Desc': 'Atualmente estou a aprender piano e a desenvolver as minhas capacidades aos poucos.',
      ...
      'edu.p2': 'O percurso incluiu projetos individuais e de grupo, com o projeto final, o RiskTrack, a obter a nota de 18/20.',
      ...
      'exp.h1': 'Ambientes diferentes, aprendizagens diferentes.',
      ...
      'exp.sonaeDesc': 'Operei robôs de paletização com tesa-filme e fiz cargas e descargas, manualmente e com recurso a máquinas. Preparei paletes para transporte num armazém de produtos alimentares, onde era preciso seguir regras rigorosas de higiene e qualidade.',
      'exp.mgesMeta1': '1 mês',
      'exp.mgesTitle': 'Assistente de Montagem de Equipamentos',
      'exp.mgesDesc': 'Ajudei a montar mais de dez elevadores automóveis na garagem de um edifício em construção. Tirei as medidas do espaço, trouxe as peças e montei-as em equipa, sempre com boa coordenação e comunicação clara em cada etapa, porque o peso das peças fazia de qualquer erro um risco real de lesão para alguém.',
      'exp.vadecaMeta1': '1 a 2 meses',
      'exp.vadecaTitle': 'Assistente de Limpeza',
      'exp.vadecaDesc': 'Preparei produtos e material de limpeza, e limpei escritórios e áreas comuns num ambiente de logística de grande escala, ajudando a manter as operações diárias organizadas e consistentes.',
    ...
    en: {
      ...
      'hero.h1': 'I build, learn and solve problems across technology.',
      'hero.text': 'I\'m Nilson Cardoso, a Computer Science and Engineering graduate from Luanda, Angola, now based in Portugal. This portfolio is an extended look at my academic work, projects and professional experience.',
      ...
      'skills.note.data': 'Mixed experience depending on the tool',
      ...
      'about.lead': 'A closer look at where I come from, what I enjoy and what shaped the way I approach work.',
      'about.p1': 'My name is Nilson Cardoso. I grew up in Luanda, Angola, and moved to Portugal at 17 to pursue a degree in Computer Science and Engineering.',
      'about.p2': 'At 18, I started living on my own and became responsible for managing my own life while continuing my studies. That experience shaped my independence, adaptability and practical approach to problem-solving.',
      'about.p3': 'Outside technology, I enjoy going to the gym and exercising, previously practised martial arts, have a long-standing interest in photography and am currently learning to play the piano.',
      ...
      'about.tl1Desc': 'Moved from Luanda to Portugal to pursue higher education.',
      'about.tl2Title': 'Started living independently',
      'about.tl2Desc': 'Began living on my own while studying.',
      'about.tl3Title': 'Started university',
      'about.tl3Desc': 'Studied Computer Science and Engineering at Universidade Lusófona do Porto.',
      'about.tl4Title': 'Graduated',
      'about.tl4Desc': 'Completed the degree and final-year project, RiskTrack, graded 18/20.',
      'about.outsideTech': 'Outside technology',
      'about.thingsIEnjoy': 'Things I enjoy.',
      'about.hobby1Title': 'Photography',
      'about.hobby1Desc': 'I used to spend a lot of time around photography and still enjoy the visual side of it.',
      'about.hobby2Title': 'Training',
      'about.hobby2Desc': 'Gym and physical exercise are part of how I keep active and maintain balance.',
      'about.hobby3Title': 'Martial arts',
      'about.hobby3Desc': 'I previously practised martial arts and enjoyed the discipline that came with it.',
      'about.hobby4Title': 'Piano',
      'about.hobby4Desc': 'I am currently learning to play piano and gradually building my skills.',

      'edu.h1': 'Where I built my foundation.',
      ...
      'edu.p1': 'I completed my degree with a strong emphasis on practical project work, combining software development, data, distributed systems and collaborative delivery.',
      ...
      'exp.h1': 'Different environments, different lessons.',
      ...
      'exp.cobolDesc': 'Completed an intensive mainframe development programme covering COBOL, JCL, VSAM and DB2, with hands-on practice in z/OS, ISPF, TSO and HOGAN. Worked through structured exercises and small programs to build a solid foundation in mainframe application development.',
      ...
      'exp.mgesDesc': 'Helped assemble more than ten vehicle lift systems in the garage of a building under construction. Took measurements across the site, brought parts into position and assembled them as a team, coordinating closely and communicating clearly at every step, since the weight of the parts made any mistake a real injury risk.',
      'exp.vadecaMeta1': '1 to 2 months',
      'exp.vadecaTitle': 'Cleaning Assistant',
      'exp.vadecaDesc': 'Prepared cleaning products and supplies, and cleaned offices and common areas in a large-scale logistics environment, contributing to organised and consistent day-to-day operations.',
      ...
      'projects.risktrack.intro': 'Individual final-year project focused on using machine learning and data analysis as support for addressing academic dropout.',
      ...
      'projects.travelex.intro': 'Group project for Distributed Systems Programming, designed to digitalise the informal practice of sending goods through travellers.',
